...
def webEntry(pg99Pct, rm_re_bin, pg_category):
    ...
    data = np.true_divide(firstCat_bin, rm_re_bin)
    
    idx = np.arange(17)
    plot1 = plt.figure()
    plt.bar(idx, data*100, width = 0.4, align = 'center', color = (0.254902, 0.411765, 0.882353) )

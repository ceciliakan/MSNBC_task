...
from singleRequest import single_request, pie_singReqst_cat, singReqst_cat_adj # single-page requests
...
pg99Pct = [ i for i in pg_raw if (len(i) >= sessLength_stats["95Pct"] and len(i) < sessLength_stats["95Pct"])  ]
...
singReqst_cat_adj(one_cat_bins, rm_re_bin, pg_category)
...
webEntry(pg99Pct, rm_re_bin, pg_category)
'''
raw_input()